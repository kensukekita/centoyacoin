...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Centoyacoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"centoyacointools.com", "192.168.0.101"},
    {"centoyacoinpool.org", "45.5.120.202"},
    {"xurious.com", "127.0.0.1"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"centoyacointools.com", "testnet-seed.centoyacointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Centoyacoin is probably already running."), addrBind.ToString().c_str());
        else
